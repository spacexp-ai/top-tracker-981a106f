    ...
    translation: {
      ...
      home: {
        ...
        bestiary: {
          ...
          description:
            "Eight icons drawn from camp ledgers — wildlife, weather, tools of the chase. Touch one to read its line.",
          lion: "Lion",
        ...
        membership: {
          ...
          perks: {
            tracker: [
              "Private member's circle",
              "Quarterly field journal",
              "Early access to dated hunts",
              "Camp invitations",
            ],
            ph: [
              "All Tracker benefits",
              "Two reserved hunt windows",
              "Personal PH pairing",
              "Trophy concierge & shipping",
              "Off-season private camp stays",
            ],
            legacy: [
              "All PH benefits",
              "Concession-naming rights",
              "Lifetime camp residency",
              "Conservation board seat",
              "Private game flights",
            ],
          },
        },
        camp: {
      ...
      ourstory: {
        ...
        intro: {
          highlight:
            "We aim to provide world-class hunting experiences that directly contribute to wildlife conservation and local community development.",
          body1:
          ...
          body2:
            "Modern hunting, done well, is not the opposite of conservation — it is one of its most powerful instruments. A percentage of every safari we run is returned to the land: anti-poaching units, water boreholes, school roofs, and game counts.",
      ...
      experience: {
        ...
        timeline: {
          ...
          1: {
            title: "Plan",
            desc: "Speak with a PH. We match you to a concession, season, and party size. Permits and logistics follow.",
          },
          2: {
            title: "Arrive",
            desc: "Charter flight to the bush strip. Camp is ready. Tracking begins at first light the next morning.",
          },
          3: {
            title: "Track",
            desc: "Days in the field with your PH and Maasai scouts. Patience, craft, and the land doing the teaching.",
          },
          4: {
            title: "Return",
            desc: "Trophies documented and shipped. CITES handled. You leave with the story; we handle everything else.",
          },
        },
        services: {
      ...
      membership_page: {
        ...
        portal: {
          ...
          feature_1: {
            ...
            body: "Reserve windows, view itineraries, and manage logistics.",
          },
          feature_2: {
            title: "Digital Field Journals",
            body: "Private logs of your hunts, photographs, and PH notes.",
          },
          feature_3: {
            title: "Trophy Tracking",
            body: "Real-time status of field preparation, CITES, and shipping.",
          },
          login: "Portal Login",
      ...
      terms_page: {
        ...
        intro:
          "These terms govern your booking with, and use of services from, Top Trackers Ltd. (Tanzania). By placing a deposit or signing a hunt agreement, you accept these terms in full.",
        section: {
          1: {
        ...
        steps: {
          ...
          3: {
            ...
            motivation_placeholder:
              "In a few lines, tell us why this club, and what you'd bring to it.",
      ...
      concessions_page: {
        ...
        intro: {
          ...
          body1:
            "A hunting concession is a legally designated wilderness block, licenced under Tanzania Wildlife Authority (TAWA) and managed exclusively by Top Trackers. No other operator hunts our land. No tourist camps. No shared tracks. Just you, your professional hunter, and the wilderness — precisely as it should be.",
          body2:
            "All three blocks are managed with annual game census, active anti-poaching patrols, and strict quota adherence — ensuring the land remains viable for generations of hunters to come.",
        },
        concessions: {
          1: {
            label: "Block I",
      ...
      camp_page: {
        ...
        intro: {
          ...
          body1:
            "Our base camp sits beneath an acacia grove near Esilalei, in the heart of the northern Tanzanian wilderness. Hand-stitched canvas tents, copper basins, and a long dining table — the full-service tented camp that serious hunters remember for decades.",
          body2:
            "This is not a lodge. It is a camp — built for the hunt, run with precision, and alive with the sounds of the bush from the moment you arrive to the moment you leave.",
      ...
      beyond_hunt: {
        hero: {
          ...
          subtitle:
            "There are so many incredible experiences waiting in Africa. We urge you to make the most of your time.",
        },
        intro: {
        ...
        activities: {
          1: {
            ...
            desc: "Open-vehicle game drives with a dedicated scout through the concession. The Selous and Maasai Steppe blocks carry exceptional general game — elephant, giraffe, zebra, and predators in the early hours.",
            tag: "Daily",
          },
          2: {
            title: "Walking Trails",
            subtitle: "With a Scout",
            desc: "Walk the bush on foot with one of our Maasai or Wagogo scouts. Read tracks, identify trees, watch the land breathe. The most intimate way to experience the African wilderness without a rifle.",
            tag: "On request",
          },
          3: {
            title: "Bird Photography",
            subtitle: "500+ Species",
            desc: "Tanzania holds some of the most extraordinary birdlife on earth. Our concession blocks host hornbills, rollers, fish eagles, secretary birds, and the elusive pel's fishing owl. Guides provided.",
            tag: "Year-round",
          },
          4: {
            title: "Maasai Village Visits",
            subtitle: "Cultural Immersion",
            desc: "Visit the Maasai communities who live alongside our concession and help steward the land. Guided by a community liaison, these visits offer genuine cultural exchange and direct community benefit.",
            tag: "Arranged",
          },
          5: {
            title: "Milky Way Stargazing",
            subtitle: "Zero Light Pollution",
            desc: "No town within 200 kilometres. The Southern Cross, the Milky Way core, and the full sweep of the southern sky. We keep a telescope on the camp deck — and the bush is absolutely quiet at midnight.",
            tag: "Every night",
          },
          6: {
            title: "Helicopter Charter",
            subtitle: "Wild Coast Scenic Flights",
            desc: "See Tanzania from above — sweeping over the Rift Valley, the great concession blocks, and the remote floodplains. Charter available for scenic flights, photography, and inter-camp transfers.",
            tag: "On request",
          },
        },
        enquire: "Enquire",
    ...
    translation: {
      ...
      home: {
        hero: {
          ...
          description:
            "Afrika legelőkelőbb vadászkörében — ahol a hajszát a türelem, a szakértelem és a tisztelet formálja.",
        ...
        bestiary: {
          ...
          description:
            "Nyolc ikon a tábori naplókból — vadvilág, időjárás, a vadászat eszközei. Érintse meg az egyiket a sor elolvasásához.",
          lion: "Oroszlán",
        ...
        experience: {
          ...
          bullet3:
            "Teljes körű szolgáltatást nyújtó sátortáborok sárgaréz, vászon és lámpafény mellett",
        ...
        membership: {
          ...
          description:
            "Három tagsági szint. Mindegyik kapukat nyit mélyebbre a bozótban, a táborban és a közösségben.",
          ...
          perks: {
            tracker: [
              "Privát tagi kör",
              "Negyedéves terepi folyóirat",
              "Korai hozzáférés a kijelölt vadászatokhoz",
              "Tábori meghívók",
            ],
            ph: [
              "Minden Nyomkereső előny",
              "Két fenntartott vadászati időszak",
              "Személyes PH párosítás",
              "Trófea és szállítási asszisztencia",
              "Szezonon kívüli magántábori tartózkodás",
            ],
            legacy: [
              "Minden Hivatásos Vadász előny",
              "Névadási jog a vadászterületekhez",
              "Élethosszig tartó tábori lakhatás",
              "Természetvédelmi igazgatósági szék",
              "Privát repülőutak a vadászterületekre",
            ],
          },
        },
        camp: {
      ...
      ourstory: {
        ...
        intro: {
          highlight:
            "Célunk, hogy olyan világszínvonalú vadászati élményeket nyújtsunk, amelyek közvetlenül hozzájárulnak a vadvilág megőrzéséhez és a helyi közösség fejlesztéséhez.",
          body1:
            "Minden expedíció a Top Trackersnél úgy van kialakítva, hogy ne csak egy vadászatot, hanem egy átalakító utazást biztosítson a vad Afrika szívébe. Munkánk jóval az első hajnali indulás előtt kezdődik — a vadászterületeink körüli falvak véneivel, a vadőrökkel és nyomkeresőkkel, akik név szerint ismernek minden gerincet, és a biológusokkal, akik évről évre meghatározzák a kvótáinkat.",
          body2:
            "A modern vadászat, ha jól csinálják, nem a természetvédelem ellentéte — hanem annak egyik leghatékonyabb eszköze. Minden szafari bevételének egy része visszakerül a földbe: orvvadászat elleni egységekre, vízforrásokra, iskolatetőkre és vadállomány-számlálásra.",
      ...
      contact: {
        ...
        form: {
          ...
          footnote:
            "A letét teljes mértékben beszámításra kerül a szafari egyenlegébe. Visszatérítendő az indulás előtt 120 napig.",
      ...
      experience: {
        ...
        timeline: {
          ...
          1: {
            title: "Tervezés",
            desc: "Beszéljen egy hivatásos vadásszal (PH). Kiválasztjuk a területet, szezont és a csoport méretét. A többi a mi dolgunk.",
          },
          2: {
            title: "Érkezés",
            desc: "Különjárat a bozót repülőterére. A tábor készen áll. A nyomkövetés másnap hajnalban indul.",
          },
          3: {
            title: "Nyomon követés",
            desc: "Napok a terepen a PH-val és maasai nyomkeresőkkel. Türelem, szakértelem és a természet tanítása.",
          },
          4: {
            title: "Visszatérés",
            desc: "A trófeák dokumentálása és szállítása. A CITES engedélyeket mi intézzük. Ön a történettel távozik, mi intézünk mindent.",
          },
        },
        services: {
        ...
        rifle: {
          ...
          footnote:
            "Minden bérelt puskát belőjük az Ön táborba érkezésekor. Prémium lőszert biztosítunk darabáron.",
        },
        camp: {
          eyebrow: "A Tábor",
      ...
      membership_page: {
        ...
        portal: {
          ...
          feature_1: {
            title: "Expedíciók Kezelése",
            body: "Időpontok lefoglalása, útvonalak megtekintése és logisztika kezelése.",
          },
          feature_2: {
            title: "Digitális Terepi Naplók",
            body: "Privát naplók a vadászatokról, fényképekről és PH jegyzetekről.",
          },
          feature_3: {
            title: "Trófeakövetés",
            body: "A terepi előkészítés, a CITES és a szállítás valós idejű állapota.",
          },
      ...
      journal: {
        ...
        entries: {
          1: {
            ...
            excerpt:
              "Tizenegy nap az akácia alatt és a szél, amely soha nem csillapodott. A türelem az egyetlen valuta, amit az öreg bikák elfogadnak.",
            tag: "Terepi Jegyzetek",
          },
          2: {
            title: "Miért számoltuk meg az oroszlánokat, mielőtt eladtuk a vadászatot",
            excerpt:
              "Éves számlálásunk a Selous területén, és mit mondtak a számok a kvótáról, a prédáról és a visszafogottság áráról.",
            tag: "Természetvédelem",
          },
          3: {
            title: "Sárgaréz, vászon és a táborozás elveszett művészete",
            excerpt:
              "Séta az Esilalei bázistáborban a vászonmesterrel, aki harminc szezonon át varrta sátrainkat.",
            tag: "Tábori Élet",
          },
          4: {
            title: "Maasai Steppe — egy szezon tudósításokban",
            excerpt:
              "Hat tag, két hivatásos vadász, egy lehetetlen kudu. Visszaemlékezések a 2025-ös hajtóvadászat hétvégéjéről.",
            tag: "Expedíció",
          },
        },
      },
      ...
      privacy_page: {
        ...
        intro:
          "A Top Trackers Kft. tiszteletben tartja az Ön adatvédelmét. Ez az irányelv elmagyarázza, mit gyűjtünk, miért, és mit nem fogunk soha tenni az Ön adataival.",
        section: {
          1: {
            title: "Amit gyűjtünk",
      ...
      terms_page: {
        ...
        intro:
          "Ezek a feltételek szabályozzák a Top Trackers Kft.-vel (Tanzánia) való foglalását és szolgáltatásainak igénybevételét. A letét befizetésével vagy a vadászati szerződés aláírásával Ön teljes mértékben elfogadja ezeket a feltételeket.",
        section: {
          1: {
      ...
      estimator_embed: {
        ...
        total_footnote:
          "Tartalmazza a tábort, a PH-t, a nyomkövetést és a trófeák előkészítését. Nem tartalmazza a szállítást és az adókat.",
      ...
      membership_apply: {
        ...
        steps: {
          ...
          2: {
            ...
            exp_placeholder:
              "Vadászattal töltött évek, földrajzi helyek, veszélyes vad vadászati tapasztalat…",
          ...
          3: {
            ...
            motivation_placeholder:
              "Pár sorban mondja el, miért ezt a klubot választja, és mit hozna magával a közösségünkbe.",
            agreement:
              "Elolvastam és elfogadom a Szolgáltatási feltételeket és az Adatvédelmi irányelveket.",
          },
        },
        buttons: {
          back: "Vissza",
      ...
      weather: {
        ...
        wind: "szél",
        horizon:
          "Az előrejelzési időtáv kb. 16 nap — a mai adatokat mutatjuk. A vadászat dátumait a foglaláskor igazoljuk vissza.",
        clear: "Tiszta",
      ...
      concessions_page: {
        ...
        intro: {
          ...
          body1:
            "A vadászterület egy jogilag kijelölt természetes terület, amelyet a Tanzániai Vadvilági Hatóság (TAWA) engedélyez, és amelyet kizárólag a Top Trackers kezel. Más üzemeltető nem vadászik a mi területünkön. Nincs turista tábor. Nincs megosztott nyom. Csak Ön, a profi vadásza és a vadon — pontosan úgy, ahogy kell.",
          body2:
            "Mindhárom területet éves vadszámlálással, aktív orvvadászat elleni járőrözéssel és szigorú kvótabetartással kezeljük — biztosítva, hogy a terület a jövő vadászgenerációi számára is életképes maradjon.",
        },
        concessions: {
          1: {
            label: "I. Terület",
      ...
      camp_page: {
        ...
        intro: {
          ...
          body1:
            "Bázistáborunk egy akácia berkenyés alatt található Esilalei közelében, Észak-Tanzánia vadonjának szívében. Kézzel varrt vászonsátrak, rézmedencék és egy hosszú étkezőasztal — a komoly vadászok által évtizedekig emlékezett teljes körű sátortábor.",
          body2:
            "Ez nem szálloda. Ez egy tábor — a vadászathoz épített, pontossággal működtetett és az érkezéstől a távozásig a vadon hangjaitól élő hely.",
        ...
        amenities: {
          ...
          1: {
            title: "Vászon Sátor Svitek",
            body: "Kézzel varrt vászon rézszerelvényekkel, rendes ágyak fehérneművel és privát vedervizes zuhany. Meleg víz hajnalban és alkonyatkor. Elég csendes ahhoz, hogy hallja a lappantyúkat.",
          },
          2: {
            title: "Tűzhelyes Konyha",
            body: "Táborunk szakácsa keményfaparázs felett főz. Háromfogásos vacsorák a vadonban, tábori reggelik a nyomkövetés előtt és teáskészlet szállítva a sátorba az első fénynél.",
          },
          3: {
            title: "A Hosszú Asztal",
            body: "Minden este a tábor egy hosszú asztalnál gyűlik össze a csillagok alatt. Történetek, single malt és a hiénák halk hívása az ártérről.",
          },
          4: {
            title: "Tejút Éjszakák",
            body: "200 kilométeren belül nincs fényszennyezés. A Déli Kereszt minden este felemelkedik a tábor felett. A teraszon tartunk egy távcsövet — használja.",
          },
          5: {
            title: "Tábori Terasz & Bush Bár",
            body: "Egy emelt teakfa terasz néz a vízlelőhelyre. A naplemente óra kötelező. Hideg Kilimanjaro sörök és a nap történetei miközben a vadon jön inni.",
          },
          6: {
            title: "Személyzet & Inas",
            body: "Dedikált tábor menedzser, nyomkövető csapat és inas szolgálat. Felszerelése minden reggel tisztítva, szárítva és készen áll. Semmi sem túl sok megszervezni.",
          },
        },
        gallery: {
          eyebrow: "A Táborból",
      ...
      beyond_hunt: {
        hero: {
          ...
          title_italic: "Túl.",
          subtitle:
            "Rengeteg csodálatos élmény vár Afrikában. Arra biztatjuk, hogy hozza ki a legtöbbet az idejéből.",
        },
        intro: {
        ...
        activities: {
          1: {
            title: "Vadonjáratok",
            subtitle: "Napkelte & Napnyugta",
            desc: "Nyitott járműves vadonjáratok dedikált kísérővel a területen keresztül. A Selous és Maasai Sztyepp blokkok kivételes általános vadat hordoznak — elefánt, zsiráf, zebra és ragadozók a korai órákban.",
            tag: "Naponta",
          },
          2: {
            title: "Gyalogos Ösvények",
            subtitle: "Kísérővel",
            desc: "Gyalogoljon a vadonban az egyik Maasai vagy Wagogo kísérőnkkel. Nyomokat olvasson, fákat azonosítson, nézze ahogy a föld lélegzik. A leghiteleseebb módja az afrikai vadon megtapasztalásának puska nélkül.",
            tag: "Kérésre",
          },
          3: {
            title: "Madárfotózás",
            subtitle: "500+ Faj",
            desc: "Tanzánia a föld legrendkívülibb madárvilágát rejti. Területünk blokkjai szarvascsőrű madarakat, vonókákat, halászsasokat, titkármadarakat és a megfoghatatlan pelkari halászbaglyot fogadnak. Kísérők biztosítottak.",
            tag: "Egész évben",
          },
          4: {
            title: "Maasai Falulátogatások",
            subtitle: "Kulturális Elmélyülés",
            desc: "Látogassa meg a területeink mellett élő Maasai közösségeket, akik a föld gondnokai. Közösségi összekötő által vezetve ezek a látogatások valódi kulturális cserét és közvetlen közösségi hasznot kínálnak.",
            tag: "Szervezett",
          },
          5: {
            title: "Tejút Csillagvizsgálás",
            subtitle: "Zéró Fényszennyezés",
            desc: "200 kilométeren belül nincs város. A Déli Kereszt, a Tejút magja és a déli égbolt teljes íve. Tartunk egy távcsövet a tábori teraszon — és a vadon éjfélkor teljesen csendes.",
            tag: "Minden este",
          },
          6: {
            title: "Helikopter Charter",
            subtitle: "Vad Partvonal Látványrepülések",
            desc: "Nézze meg Tanzániát fentről — átrepülve a Hasadék Völgye, a nagy területblokkok és a távoli árterek felett. Charter elérhető látványrepülésekhez, fotózáshoz és táborok közötti átszállításhoz.",
            tag: "Kérésre",
          },
        },
        enquire: "Érdeklődjön",
