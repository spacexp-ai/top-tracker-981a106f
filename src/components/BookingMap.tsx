    ...
    <div className="bg-card border border-border overflow-hidden">
      <div className="flex items-center justify-between p-4 border-b border-border">
        <div>
          ...
          <div className="font-display text-lg text-forest">on the bank of Njombe River</div>
        </div>
        <a
      ...
      <div className="flex items-center justify-between gap-3 p-4 text-xs text-muted-foreground">
        <span className="flex items-center gap-1.5"><Plane className="h-3.5 w-3.5 text-ember" /> Near Ruaha National Park</span>
