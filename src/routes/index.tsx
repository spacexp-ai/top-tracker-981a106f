  ...
  head: () => ({
    meta: [
      { title: "Top Trackers — Africa's Premier Hunting Experience" },
      {
        name: "description",
        content:
          "An invitation-only safari & hunting club in the heart of Tanzania. Ethical expeditions, conservation heritage, and a vintage-modern way of the hunt.",
      },
      { property: "og:title", content: "Top Trackers — Africa's Premier Hunting Experience" },
      {
        property: "og:description",
        content: "Ethical hunting, conservation heritage, unforgettable expeditions in Tanzania.",
      },
    ],
  }),
  component: Home,
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section ref={heroRef} className="relative h-[100svh] overflow-hidden bg-ink">
        ...
        >
          ...
          >
            <div className="vintage-divider text-[10px] tracking-[0.5em] uppercase text-accent">
              <span>
                {getContent(
                  "home.hero.subtitle",
                  t("home.hero.subtitle", "In the heart of Tanzania"),
                )}
              </span>
            </div>
          </motion.div>
          ...
          >
            ...
            >
              {t("home.hero.bookSafari", "Book your safari")}{" "}
      ...
      <section className="relative paper-bg py-32 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl px-6 text-center">
          <Reveal>
            <Eyebrow>
              {getContent("home.intro.eyebrow", t("home.intro.eyebrow", "Welcome, Tracker"))}
            </Eyebrow>
          </Reveal>
          <Reveal delay={0.1}>
            <h2 className="mt-8 font-display text-4xl md:text-6xl text-forest leading-tight">
              {getContent(
                "home.intro.title_line1",
                t("home.intro.titleLine1", "More than a hunt."),
              )}
              <br />
              <span className="font-serif italic text-ember">
                {getContent("home.intro.title_line2", t("home.intro.titleLine2", "A legacy."))}
              </span>
            </h2>
          </Reveal>
          <Reveal delay={0.2}>
          ...
          <Reveal delay={0.3}>
            <Link
              to="/our-story"
              className="inline-flex items-center gap-2 mt-10 text-forest font-serif italic text-lg border-b border-forest/40 hover:border-ember hover:text-ember transition"
            >
              {t("home.intro.discoverStory", "Discover our story")}{" "}
      ...
      <section className="relative bg-ink text-bone py-32 overflow-hidden grain">
        ...
        <div className="relative mx-auto max-w-7xl px-6">
          <Reveal>
            <Eyebrow light>
              {getContent("home.pillars.eyebrow", t("home.pillars.eyebrow", "Three pillars"))}
            </Eyebrow>
          </Reveal>
          <Reveal delay={0.1}>
            ...
            {[
              {
                ...
                title: getContent(
                  ...
                  t("home.pillars.patience.title", "Patience"),
                ),
                body: getContent(
                  "home.pillars.1.body",
                  t(
                    "home.pillars.patience.body",
                    "We hunt slow. Every track is read, every wind weighed. The chase is measured in days, not minutes.",
                  ),
                ),
              },
              {
                ...
                body: getContent(
                  "home.pillars.2.body",
                  t(
                    "home.pillars.craft.body",
                    "Professional hunters with decades across Tanzania's most storied concessions. Field-tested, quietly precise.",
                  ),
                ),
              },
              {
                ...
                title: getContent(
                  ...
                  t("home.pillars.respect.title", "Respect"),
                ),
                body: getContent(
                  "home.pillars.3.body",
                  t(
                    "home.pillars.respect.body",
                    "For the animal, the land, and the communities who steward it. Conservation is the price of the privilege.",
                  ),
                ),
              },
              ...
              <Reveal key={title} delay={i * 0.1}>
                <div className="bg-ink p-10 h-full hover:bg-forest/30 transition-colors duration-300 group">
                  <Icon
                    className="h-10 w-10 text-accent group-hover:scale-110 transition-transform duration-300"
                    strokeWidth={1.2}
                  />
                  <h3 className="mt-8 font-display text-2xl tracking-[0.15em]">
                    {title.toUpperCase()}
                  </h3>
      ...
      <section className="relative paper-bg py-28 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-6">
          <div className="text-center max-w-2xl mx-auto">
            <Reveal>
              <Eyebrow>{t("home.bestiary.eyebrow", "The Field Bestiary")}</Eyebrow>
            </Reveal>
            <Reveal delay={0.1}>
              <h2 className="mt-6 font-display text-4xl md:text-5xl text-forest leading-tight">
                {t("home.bestiary.titleLine1", "Hover the quarry.")}
                <br />
                <span className="font-serif italic text-ember">
                  {t("home.bestiary.titleLine2", "Read the trail.")}
                </span>
              </h2>
            </Reveal>
            <Reveal delay={0.2}>
          ...
          <div className="mt-16 grid grid-cols-2 sm:grid-cols-4 gap-px bg-forest/15">
            {[
              {
                Icon: LionIcon,
                label: t("home.bestiary.lion", "Lion"),
                note: t("home.bestiary.lionNote", "Tracked at dawn — never alone."),
              },
              {
                Icon: ElephantIcon,
                label: t("home.bestiary.elephant", "Elephant"),
                note: t("home.bestiary.elephantNote", "Respect the matriarch's wind."),
              },
              {
                Icon: BuffaloIcon,
                label: t("home.bestiary.buffalo", "Buffalo"),
                note: t("home.bestiary.buffaloNote", "Black death of the Selous."),
              },
              {
                Icon: LeopardIcon,
                label: t("home.bestiary.leopard", "Leopard"),
                note: t("home.bestiary.leopardNote", "Patience baited under acacia."),
              },
              {
                Icon: AntelopeIcon,
                label: t("home.bestiary.kudu", "Kudu"),
                note: t("home.bestiary.kuduNote", "Spiral horns through the thornveld."),
              },
              {
                Icon: RifleIcon,
                label: t("home.bestiary.rifle", "The Rifle"),
                note: t("home.bestiary.rifleNote", ".375 H&H — the old reliable."),
              },
              {
                Icon: CompassRoseIcon,
                label: t("home.bestiary.bearing", "Bearing"),
                note: t("home.bestiary.bearingNote", "True north, by sun and stars."),
              },
              {
                Icon: AcaciaIcon,
                label: t("home.bestiary.acacia", "Acacia"),
                note: t("home.bestiary.acaciaNote", "Camp shade. Lantern post."),
              },
        ...
        <div className="mx-auto max-w-7xl px-6 grid md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <Reveal>
              <Eyebrow>
                {getContent(
                  ...
                  t("home.experience.eyebrow", "The Experience"),
                )}
              </Eyebrow>
            </Reveal>
            <Reveal delay={0.1}>
              <h2 className="mt-6 font-display text-4xl md:text-5xl text-forest leading-[1.1]">
                {getContent(
                  ...
                  t("home.experience.title", "A safari shaped by patience, craft, and respect."),
                )}
              </h2>
            </Reveal>
            <Reveal delay={0.2}>
            ...
            <Reveal delay={0.4}>
              ...
              >
                {t("home.experience.explore", "Explore expeditions")}{" "}
                <ArrowRight className="h-4 w-4" />
              </Link>
            </Reveal>
          </div>
      ...
      >
        <div className="mx-auto max-w-7xl px-6">
          <div className="text-center max-w-3xl mx-auto">
            <Reveal>
              <Eyebrow light>{t("home.membership.eyebrow", "The Hunting Club")}</Eyebrow>
            </Reveal>
            <Reveal delay={0.1}>
          ...
          <div className="mt-16 grid md:grid-cols-3 gap-6">
            {[
              {
                tier: t("home.membership.tiers.tracker", "Tracker"),
                price: "$2,400",
                per: "/ year",
                color: "border-bone/30",
                perks: t("home.membership.perks.tracker", { returnObjects: true }),
              },
              {
                tier: t("home.membership.tiers.ph", "Professional Hunter"),
                price: "$7,800",
                per: "/ year",
                color: "border-accent",
                featured: true,
              ...
              {
                tier: t("home.membership.tiers.legacy", "Legacy"),
                price: "By invitation",
                per: "",
                color: "border-ember",
              ...
              return (
                <Reveal key={tier} delay={i * 0.1}>
                  <div
                    className={`relative h-full p-8 border ${color} bg-ink/40 backdrop-blur-sm hover:bg-ink/70 transition-all duration-500 ${featured ? "md:-translate-y-4" : ""}`}
                  >
                    {featured && (
                    ...
                    <h3 className="font-display text-2xl tracking-[0.15em] uppercase text-accent">
                      {tier}
                    </h3>
          ...
          <Reveal delay={0.4}>
            <div className="mt-14 text-center">
              ...
              >
                {t("home.membership.request", "Request Membership")}{" "}
                <ArrowRight className="h-4 w-4" />
              </Link>
            </div>
          </Reveal>
      ...
      <section className="relative paper-bg py-32 overflow-hidden">
        <div className="mx-auto max-w-7xl px-6 grid md:grid-cols-5 gap-12 items-center">
          <div className="md:col-span-2">
            <Reveal>
              <Eyebrow>
                {getContent("home.camp.eyebrow", t("home.camp.eyebrow", "The Camp"))}
              </Eyebrow>
            </Reveal>
            <Reveal delay={0.1}>
              <h2 className="mt-6 font-display text-4xl md:text-5xl text-forest leading-[1.1]">
                {getContent("home.camp.title_line1", t("home.camp.titleLine1", "Canvas, brass &"))}
                <br />
                <span className="font-serif italic text-ember">
                  {getContent("home.camp.title_line2", t("home.camp.titleLine2", "lantern light."))}
                </span>
              </h2>
            </Reveal>
            <Reveal delay={0.2}>
          ...
          <Reveal delay={0.2}>
            <div className="mt-10 vintage-divider text-[10px] tracking-[0.5em] uppercase text-accent">
              <span>
                {getContent(
                  "home.quote.author",
                  t("home.quote.author", "Hemingway, paraphrased — and lived"),
                )}
              </span>
            </div>
          </Reveal>
      ...
      <section className="relative paper-bg py-28">
        <div className="mx-auto max-w-4xl px-6 text-center">
          ...
          <Reveal delay={0.1}>
            <h2 className="mt-6 font-display text-4xl md:text-6xl text-forest">
              ...
              <span className="italic font-serif text-ember">
                {getContent("home.cta.title_italic", t("home.cta.titleItalic", "first chase"))}
              </span>
              .
            </h2>
          </Reveal>
          ...
          <Reveal delay={0.3}>
            <Link
              to="/contact"
              className="inline-flex items-center gap-2 mt-10 px-8 py-4 bg-forest text-bone tracking-[0.3em] text-[11px] uppercase hover:bg-ember transition"
            >
