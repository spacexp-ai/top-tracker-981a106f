  ...
  async function save(e: React.FormEvent) {
    ...
    const { error } = await supabase
      ...
      .update({
        ...
        firearm_permit_num: firearmPermitNum,
      ...
      <div className="max-w-4xl space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
        <form onSubmit={save} className="space-y-8">
          ...
          <div className="bg-[#2d2d2d] border border-[#3d3d3d] p-8">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div>
                ...
                <input
                  value={firearmPermitNum}
                  onChange={(e) => setFirearmPermitNum(e.target.value)}
                  className="w-full bg-[#1a1a1a] border border-[#3d3d3d] focus:border-[#c9a84c] focus:outline-none px-4 py-3 text-sm text-[#f5f5f0] transition-colors"
                />
              </div>
            </div>
          ...
          <div className="bg-[#2d2d2d] border border-[#3d3d3d] p-8">
            ...
            <div>
              <label className="block text-[10px] tracking-[0.3em] uppercase text-[#a8a8a0] mb-3">
                Primary Interests
              </label>
          ...
          <div className="bg-[#2d2d2d] border border-[#3d3d3d] p-8">
            ...
            <div>
              <label className="block text-[10px] tracking-[0.3em] uppercase text-[#a8a8a0] mb-2">
                Dietary Requirements / Medical Info
              </label>
              <textarea
                value={dietary}
                onChange={(e) => setDietary(e.target.value)}
                rows={3}
                placeholder="Please list any allergies or dietary requirements for camp preparation..."
                className="w-full bg-[#1a1a1a] border border-[#3d3d3d] focus:border-[#c9a84c] focus:outline-none px-4 py-3 text-sm text-[#f5f5f0] resize-none transition-colors"
              />
            </div>
          </div>
            ...
            <div className="bg-[#2d2d2d] border border-[#3d3d3d] p-8">
              ...
              <label className="flex items-start gap-4 cursor-pointer group">
                <div className="relative mt-0.5">
                  ...
                  />
                  <div
                    className={`w-10 h-5 bg-[#1a1a1a] border transition-colors ${isPublic ? "border-[#c9a84c]" : "border-[#3d3d3d]"}`}
                  ></div>
                  <div
                    className={`absolute top-1 left-1 w-3 h-3 bg-[#a8a8a0] transition-transform ${isPublic ? "translate-x-5 bg-[#c9a84c]" : ""}`}
                  ></div>
                </div>
                <div>
            ...
            <div className="bg-[#2d2d2d] border border-[#3d3d3d] p-8">
              ...
              <div>
                ...
                <p className="mt-3 text-xs text-[#a8a8a0]">
                  Your tier determines which concessions and premium features you can access. To
                  upgrade your tier, please contact your Professional Hunter.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="sticky bottom-4 flex items-center justify-between bg-[#1a1a1a]/95 backdrop-blur-md border border-[#3d3d3d] p-4 shadow-2xl">
            <div className="flex items-center gap-3">
              {msg && (
                <span className="text-[10px] tracking-[0.2em] uppercase text-[#c9a84c] animate-in fade-in">
                  {msg}
                </span>
              )}
            </div>
            <button
              type="submit"
              disabled={isSaving}
              className="inline-flex items-center gap-2 px-8 py-3 bg-[#c9a84c] text-[#1a1a1a] text-[10px] tracking-[0.3em] uppercase hover:bg-[#b0903c] transition-colors font-semibold disabled:opacity-50"
            >
