        ...
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-700 ease-out">
          ...
          <div className="grid gap-5 md:grid-cols-3 mt-8">
            <div className="md:col-span-2 space-y-8">
              ...
              {/* Quick actions */}
              <div>
                <div className="text-[10px] tracking-[0.4em] uppercase text-[#a8a8a0] mb-3">Portal actions</div>
              ...
              <div>
                ...
                <ul className="bg-[#2d2d2d] border border-[#3d3d3d] divide-y divide-[#3d3d3d]">
                  {(data?.bookings ?? []).slice(0, 5).map((b) => (
                    <li key={b.id} className="px-5 py-3 flex items-center justify-between text-sm hover:bg-[#1a1a1a]/50 transition">
              ...
              <div>
                ...
                <div className="bg-[#2d2d2d] border border-[#3d3d3d] p-5 space-y-6">
                  <div className="border-l-2 border-[#c9a84c] pl-3">
                    ...
                    <div className="text-xs text-[#a8a8a0]">Join us in Dallas for our annual fundraiser supporting African wildlife corridors.</div>
                  </div>
                  <div className="border-l-2 border-[#3d3d3d] pl-3">
                    ...
                    <div className="text-xs text-[#a8a8a0]">We've expanded our tracking area. Update your preferences if you're hunting in Q3.</div>
                  </div>
                  <div className="border-l-2 border-[#3d3d3d] pl-3">
                    ...
                    <div className="text-xs text-[#a8a8a0]">New Blaser R8 setups are now available for rent in our standard camps.</div>
                  </div>
                </div>
              </div>
            </div>
...
function ActionLink({ to, icon: Icon, children }: { to: string; icon: React.ComponentType<{ className?: string }>; children: React.ReactNode }) {
  return (
    <Link to={to} className="inline-flex items-center gap-2 px-4 py-2.5 bg-[#1a1a1a] border border-[#3d3d3d] hover:border-[#c9a84c] hover:text-[#c9a84c] text-xs tracking-[0.2em] uppercase text-[#a8a8a0] transition shadow-sm">
