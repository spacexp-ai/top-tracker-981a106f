...
export const Route = createFileRoute("/beyond-the-hunt")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Non-hunting safari experiences in Tanzania. Game drives, walking trails, Maasai village visits, stargazing, bird photography, and helicopter charters." },
      { property: "og:title", content: "Beyond the Hunt — Top Trackers" },
      { property: "og:description", content: "There are so many incredible experiences waiting in the Tanzanian wilderness — beyond the rifle." },
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative h-[65svh] bg-ink overflow-hidden">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-center px-6 text-bone">
          ...
          >
            BEYOND{" "}
            <span className="font-serif italic text-accent">the Hunt.</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        <div className="relative mx-auto max-w-4xl px-6 text-center">
          ...
          <Reveal delay={0.2}>
            <p className="mt-8 font-serif text-xl leading-relaxed text-foreground/80">
              There are so many incredible experiences just waiting for you in Tanzania. Whether you've hung up the rifle
              for the afternoon, brought a partner who doesn't hunt, or planned a standalone non-hunting safari — we
              arrange custom experiences to complement your time in the bush.
            </p>
          </Reveal>
          <Reveal delay={0.3}>
              ...
              <Reveal key={act.id} delay={i * 0.07}>
                <article className="group relative overflow-hidden aspect-[16/10]">
                  ...
                  <div className="absolute inset-x-0 bottom-0 p-7 md:p-8">
                    <p className="text-[9px] tracking-[0.4em] uppercase text-accent/80 mb-1">{act.subtitle}</p>
        ...
        <div className="relative mx-auto max-w-4xl px-6 text-center">
          <Reveal>
            <div className="inline-block border border-accent/50 px-5 py-2 mb-6">
              <span className="text-[10px] tracking-[0.5em] uppercase text-accent">For Partners & Guests</span>
            </div>
          </Reveal>
          <Reveal delay={0.1}>
          ...
          <Reveal delay={0.2}>
            <p className="mt-7 font-serif text-xl text-bone/75 max-w-2xl mx-auto leading-relaxed">
              Non-hunting partners and companions stay in camp with full access to meals, the bar, and the camp deck —
              included in the hunt package rate. A non-hunting itinerary is prepared on request.
            </p>
          </Reveal>
          <Reveal delay={0.3}>
          ...
          <Reveal>
            <div className="flex items-baseline justify-between flex-wrap gap-4 mb-10">
              <div>
                ...
                <h2 className="mt-3 font-display text-3xl md:text-4xl text-forest">What you might see.</h2>
              </div>
              <Link
                to="/gallery"
