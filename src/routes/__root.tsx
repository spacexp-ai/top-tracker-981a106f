  ...
  return (
    <div className="flex min-h-screen items-center justify-center paper-bg px-4">
      <div className="max-w-md text-center">
        ...
        <Link
          to="/"
          className="inline-block mt-8 px-6 py-3 bg-forest text-bone tracking-[0.25em] text-xs uppercase"
        >
          Return to camp
        </Link>
      </div>
      ...
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex gap-3 justify-center">
          <button
            ...
            className="px-5 py-2.5 bg-forest text-bone tracking-[0.2em] text-xs uppercase"
          >
            Try again
          </button>
          <a
            href="/"
            className="px-5 py-2.5 border border-forest text-forest tracking-[0.2em] text-xs uppercase"
          >
            Home
          </a>
        </div>
  ...
  head: () => ({
    meta: [
      ...
      { title: "Top Trackers — Premium Hunting Club, Tanzania" },
      {
        name: "description",
        content:
          "An invitation-only African safari & hunting club rooted in Tanzania. Ethical hunts, conservation heritage, and unforgettable expeditions.",
      },
      ...
      },
      {
        property: "og:image",
        content:
          "https://storage.googleapis.com/gpt-engineer-file-uploads/JyGsTAOQ23TQxYWaD0RvuQ1Yn9A2/social-images/social-1779975367064-f5a3388c-7776-44e0-92d7-55cf79b6b35a-2026-05-16.webp",
      },
      {
        name: "twitter:image",
        content:
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Cinzel:wght@400;500;600;700&family=Cormorant+Garamond:ital,wght@0,400;0,500;0,600;1,400&family=Playfair+Display:wght@500;600;700&family=Inter:wght@300;400;500;600&display=swap",
      },
